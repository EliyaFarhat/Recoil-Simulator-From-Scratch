...
BULLET_LIMIT = 25 # bullets on the screen at a time
...
TARGET_DISTANCE = 2500 # units away
...
def ShootGun():
    ...
    SHOOT_SOUND.play()
    randomVector = random_vector_in_cone(FIRST_SHOT_SPREAD) # modify this to add previous bullet dependence
